...
st.markdown("This heatmap shows where increased policy implementation scores coincide with reduced tobacco use from 2007 to 2022. Green indicates desired policy effects (↑ implementation, ↓ prevalence), while red signals unintended trends.")
