...
presentation_page = st.Page("Pages/02_Data_Sources.py", title = "Data Sources", icon="🗂️")
...
conc_page = st.Page("Pages/07_Conclusion_and_Outlook.py", title="Conclusion", icon="🏁")
